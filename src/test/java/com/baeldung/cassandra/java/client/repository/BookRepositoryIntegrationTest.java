...
public class BookRepositoryIntegrationTest {
    ...
    @Test
    public void whenAddingANewBookAgain_thenBookExists() {
        bookRepository.deleteTable(BOOKS);
        bookRepository.createTable();

        String title = "DevOps With OpenShift";
        String author = "Batman and friends";
        Book book = new Book(UUIDs.timeBased(), title, author, "Programming");
        bookRepository.insertbook(book);
        ...
        assertEquals(1, books.size());
        assertTrue(books.stream().anyMatch(b -> b.getTitle().equals("DevOps With OpenShift")));
    }
